...
<html lang="en">
  ...
  <form action ="ChangeInfoServlet" class="form-horizontal">
    <fieldset>
      <div id="legend" class="">
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input name="newpassword" type="password" placeholder="" class="input-xlarge">
            <p class="help-block"></p>
          </div>
        </div>
    ...
    <div class="control-group">
          ...
          <div class="controls">
            <input name="confirmpassword" type="password" placeholder="" class="input-xlarge">
            <p class="help-block"></p>
          </div>
        </div>
