...
privileged aspect CardController_Roo_Controller {
    ...
    void CardController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("card_createdat_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("card_updatedat_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
