...
privileged aspect CircleController_Roo_Controller {
    ...
    void CircleController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("circle_createdat_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("circle_updatedat_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
